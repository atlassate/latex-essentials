...
\section{\protect\verbum{latexcode} 环境与 \protect\verbum*{inputlatexcode} 命令}

为了显示{\LaTeX}代码和现实渲染结果
\footnote{实现类似\verbum{tcblisting}环境的功能}，可以采用：
\begin{itemize}
  \item \verbum{latexcode} 环境：工作过程是将代码输出到文件，读取并渲染该文件
